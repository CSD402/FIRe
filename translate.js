...
(function (_) {
    ...
    try {
        ...
        Ja = function () {
            var a =
                'undefined' !== typeof window ? window.trustedTypes : void 0;
  ...
  */
        ...
        _.Zc = function () {
            return (
                ...
                Math.abs(
                    Math.floor(2147483648 * Math.random()) ^ _.ub(),
                ).toString(36)
            );
        };
        var cd, bd, pd, qd;
                ...
                if (_.p.Promise && _.p.Promise.resolve) {
                    ...
                    he = function () {
                        ...
                        (_.p.Window &&
                            ...
                            !_.t('Edge') &&
                            _.p.Window.prototype.setImmediate ==
                                _.p.setImmediate)
                            ? (ce || (ce = de()), ce(b))
                            : _.p.setImmediate(b);
                    };
  ...
  */
            ...
            if (!(this instanceof Re)) this.Sf(a, b);
                ...
                for (var c = [], d = 0; d < a.length; d++) {
                    ...
                    this.g[f]
                        ? ((f = this.g[f].zc()),
                          f != e &&
                              f.splice.apply(f, [0, f.length].concat(_.ab(e))))
                        : (this.g[f] = new Mb(e, f));
                }
                b && b.length
        ...
        var qf = function (a) {
                if (a instanceof mf || a instanceof nf || a instanceof of)
                    return a;
